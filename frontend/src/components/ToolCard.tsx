...
export default function ToolCard({ tool }: { tool: ToolItem }) {
    return (
        <article className="group flex flex-col h-full bg-card backdrop-blur-xl rounded-2xl border border-border shadow-sm hover:shadow-md overflow-hidden transition-all duration-300 hover:scale-[1.01] hover:bg-white/10 hover:border-white/20 active:scale-[0.98] active:opacity-90">
